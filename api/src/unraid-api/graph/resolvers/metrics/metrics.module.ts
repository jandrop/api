...
import { NetworkMetricsModule } from '@app/unraid-api/graph/resolvers/metrics/network-metrics/network-metrics.module.js';
...
@Module({
    imports: [ServicesModule, CpuModule, TemperatureModule, NetworkMetricsModule],
